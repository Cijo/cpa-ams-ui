...
var _AuthenticationContext = function () {
   ...
   *  @property {Boolean} isFormPostResponseMode - Set this to true to enable form_post as response_mode.
   */
  ...
  */
  ...
  _AuthenticationContext.prototype.logOut = function () {
    // YKE: FIX logout redirect: get id_token
    var idTokenInfo = this._getItem(this.CONSTANTS.STORAGE.IDTOKEN);
    ...
    if (this.config.logOutUri) {
      ...
      if (this.config.postLogoutRedirectUri) {
        logout = 'post_logout_redirect_uri=' + encodeURIComponent(this.config.postLogoutRedirectUri); // YKE: FIX logout redirect: append id_token_hint param

        logout += "&id_token_hint=" + idTokenInfo;
      }
  ...
  */
  ...
  _AuthenticationContext.prototype._serialize = function (responseType, obj, resource) {
    ...
    if (obj !== null) {
      ...
      if (obj.isFormPostResponseMode) {
        str.push('response_mode=form_post');
      }
